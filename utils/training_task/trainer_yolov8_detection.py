...
class YoloDetectionTask(Task):
    name = 'tasks.train.yolov8.detection'
...
@task(bind=True, base=YoloDetectionTask)
def start_training_yolo_detection_task(self, project_dir: str, task_id: str):
    try:
