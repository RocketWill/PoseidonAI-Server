...
class Dataset:
    def __init__(self, user_id, name, description, detect_type_id, label_file, image_files, valid_images_num, save_key, dataset_format_ids, class_names=[], statistics={}, created_at=None):
        self._id = None
    ...
    def from_dict(dataset_data):
        user = Dataset(
            ...
            statistics=dataset_data.get('statistics', {})
        )
...
class TrainingTask:
    def __init__(self, name, user_id, algorithm_id, dataset_id, training_configuration_id, model_name, epoch, val_ratio, gpu_id, save_key, train_val_num=[], description='', summary=[]):
        self.user_id = user_id
        self.name = name
